...
$conn = new mysqli("localhost", "root", "", "DB_GeV");
...
if (isset($_POST['loginEmail']) && isset($_POST['loginPassword'])) {
    ...
    $email_admin = 'admin@example.com'; // Substitua pelo email desejado
    $senha_admin = 'senha_admin'; // Substitua pela senha desejada
